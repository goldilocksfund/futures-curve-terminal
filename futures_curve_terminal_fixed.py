...
def main() -> None:
    ...
    with tab1:
        ...
        with left:
            ...
            fig.add_trace(go.Scatter(x=labels, y=primary_data.prices, fill="tozeroy", fillcolor=fill_color, mode="lines", line=dict(color="rgba(0,0,0,0)", width=0), showlegend=False, hoverinfo="skip"))
